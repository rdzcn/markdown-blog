...
const ArticleForm = () => {
  ...
  return (
    <form
      ...
      className="flex flex-col max-w-md rounded-md bg-gradient-to-b from-customYellow via-customPurple to-customDarkBlue p-4"
    >
      <label className="flex h-10 p-2 mb-4 text-white" htmlFor="author">
        <span className="min-w-24">Author</span>
        <input
          {...register("author", { required: true })}
          className="outline ml-4 flex-1"
        />
      </label>
      ...
      <button
        type="submit"
        className="text-white rounded-md border border-white border-solid"
      >
        Submit
      </button>
    </form>
